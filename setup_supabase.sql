-- JMNL Productivity - Configuration complète Supabase
...
-- POLITIQUES RLS POUR LA TABLE TIME_ENTRIES
...
-- POLITIQUES RLS POUR LA TABLE RESOURCES
...
-- POLITIQUES RLS POUR LA TABLE JOURNAL_ENTRIES
